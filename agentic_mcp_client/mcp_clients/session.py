...
from agentic_mcp_client import __version__ as version
from agentic_mcp_client.sampling.sampler import handle_sampling_message
            ...
            types.ClientRequest(
                types.InitializeRequest(
                    ...
                    params=types.InitializeRequestParams(
                        ...
                        clientInfo=types.Implementation(name="agentic-mcp-client", version=version),
                    ),
                )
            ),
